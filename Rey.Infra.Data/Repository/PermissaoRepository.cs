...
namespace Rey.Infra.Data.Repository
{
    public class PermissaoRepository : IPermissaoRepository
    {
        ...
        {
            EntityEntry<Permissao> ops = _context.PermissoesExternas.Add(perfil);
        ...
        public List<Perfil> ObterPerfisDeUsuario(int usuarioId)
        {
        ...
        public List<Permissao> RetrievePermissionsByProfile(Perfil perfil)
        {
        ...
        public bool Update(Permissao perfilExternoViewModel)
        {
